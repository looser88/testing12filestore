...
@Bot.on_message((filters.document | filters.video | filters.audio | filters.photo) & ~filters.edited & ~filters.chat(Config.DB_CHANNEL))
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == "private":
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support Group](https://t.me/Dot_serials_bot)",
                                     disable_web_page_preview=True)
            return
        ...
        try:
            ...
            share_link = f"https://t.me/{Config.BOT_USERNAME}?start=Dot_{str_to_b64(file_er_id)}"
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/Dot_serials_bot).",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
